...
* [Liquibase Migration](https://docs.spring.io/spring-boot/docs/2.7.10/reference/htmlsingle/#howto.data-initialization.migration-tool.liquibase)
* [Spring Web](https://docs.spring.io/spring-boot/docs/2.7.10/reference/htmlsingle/#web)
* [JOOQ Access Layer](https://docs.spring.io/spring-boot/docs/2.7.10/reference/htmlsingle/#data.sql.jooq)
